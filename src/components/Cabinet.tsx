            ...
            <>
              ...
              >
                ...
                <div className="absolute inset-2 opacity-30">
                  <div className="absolute top-4 left-4 text-orange-600 text-xl">🌟</div>
                  <div className="absolute bottom-4 right-4 text-yellow-600 text-lg">✨</div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-orange-500 text-sm">🏺</div>
                </div>
              </motion.div>
              ...
              >
                ...
                {/* Fun Pattern */}
                <div className="absolute inset-2 opacity-30">
                  <div className="absolute top-4 right-4 text-orange-600 text-xl">🌟</div>
                  <div className="absolute bottom-4 left-4 text-yellow-600 text-lg">✨</div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-orange-500 text-sm">🍯</div>
                </div>
              </motion.div>
