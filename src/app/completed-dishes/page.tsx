...
export default function CompletedDishesPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      const dishes = JSON.parse(localStorage.getItem('completedDishes') || '[]');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-red-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-40 right-20 text-5xl animate-float" style={{ animationDelay: '0.5s' }}>🎪</div>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-2">
            Now try eating this mate! 😂
          </p>
          <p className="text-lg text-gray-500">
            (Spoiler alert: You can&apos;t, because it&apos;s completely virtual and useless!)
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-purple-200 text-center">
            ...
            <div className="text-2xl font-bold text-purple-600">{completedDishes.length}</div>
            <div className="text-gray-600">Dishes Completed</div>
          </div>
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-pink-200 text-center">
            <div className="text-4xl mb-2">💯</div>
            <div className="text-2xl font-bold text-pink-600">{getTotalUselessness()}%</div>
            <div className="text-gray-600">Total Uselessness</div>
          </div>
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-red-200 text-center">
            <div className="text-4xl mb-2">🎭</div>
            <div className="text-2xl font-bold text-red-600">∞</div>
            <div className="text-gray-600">Beauty Points</div>
          </div>
        </motion.div>
        ...
        {completedDishes.length > 0 ? (
              ...
              {completedDishes.map((dish, index) => (
                ...
                >
                  <div className="text-center">
                    <div className="text-6xl mb-4 animate-bounce">{dish.emoji}</div>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-600 mb-2">No dishes completed yet!</h3>
            <p className="text-gray-500">Go back to the kitchen and start cooking some useless masterpieces!</p>
          </motion.div>
        )}
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-800 mb-4 flex items-center justify-center">
              ...
              The Art of Beautiful Uselessness
              <Sparkles className="ml-2 text-yellow-500" />
            </h3>
            <div className="space-y-4 text-gray-600">
              <p className="text-lg">
                🎭 <strong>Congratulations!</strong> You&apos;ve successfully created something completely useless but absolutely gorgeous!
              </p>
              <p>
                🖼️ Your virtual dishes are works of art that exist only in pixels and imagination.
              </p>
              <p>
                🤡 You can look at them, admire them, screenshot them, but you definitely can&apos;t eat them!
              </p>
              <p className="text-xl font-semibold text-purple-600">
                🏆 Achievement Unlocked: Master of Digital Cuisine!
              </p>
            </div>
          </div>

          <div className="text-sm text-gray-400 space-y-1">
            <p>No calories were consumed in the making of these dishes</p>
            <p>No real hunger was satisfied during this experience</p>
            <p className="font-semibold">100% useless, 100% beautiful ✨</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-500 text-sm mt-3">
            Ready to create more beautiful uselessness?
          </p>
        </motion.div>
      </div>
    </div>
